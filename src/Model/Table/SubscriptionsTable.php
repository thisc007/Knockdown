 ...
 * Subscriptions Model
 *
 * @property |\Cake\ORM\Association\BelongsTo $Championshipcompetitions
...
class SubscriptionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Championshipcompetitions', [
            'foreignKey' => 'championshipcompetitions_id',
            'joinType' => 'INNER'
        ]);
    ...
    {
        $rules->add($rules->existsIn(['championshipcompetitions_id'], 'Championshipcompetitions'));
