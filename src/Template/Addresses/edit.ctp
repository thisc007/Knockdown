...
<script>
    ...
    $(document).ready(function () {
        state(document.getElementById('countries_id').value);
    });
</script>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            echo $this->Form->control('countries_id', ['id' => 'countries_id', 'options' => $countries, 'empty' => 'Escolha', 'label' => 'País', 'class' => 'form-control', 'onchange' => 'state(this.value)', 'required' => true]);
        ...
        <div class="row">
            ...
            <div class="col-lg-12"><button class='btn btn-danger btn-social' onclick="history.go(-1);return false;"><i class="fa fa-arrow-circle-left"></i>Voltar </button>&nbsp;&nbsp;
                <button id="btnx" class="btn btn-social btn-success" disabled="disabled"><i class="fa fa-arrow-circle-right"></i>Alterar</button></div>
        </div>
    </div>
</div>