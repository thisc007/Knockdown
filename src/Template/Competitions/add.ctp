...
<div class="panel panel-default">
    ...
    <div class="panel panel-body">
        ...
        <div class="form-group">
            ...
            echo $this->Form->control('maxtrainingage', ['label' => 'Tempo de Treino Máximo (anos) - Caso não tenha limite, deixar zerado', 'class' => 'form-control']);
            ...
            echo $this->Form->control('type', ['label' => 'Tipo', 'class' => 'form-control', 'options' => ['0' => 'Luta', '1' => 'Formas']]);
