...
/**
 * AssociationphonesFixture
 */
class AssociationphonesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_associations_associationphones_idx' => ['type' => 'index', 'columns' => ['associations_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_associations_associationphones' => ['type' => 'foreign', 'columns' => ['associations_id'], 'references' => ['associations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
